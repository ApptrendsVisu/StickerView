...
public class StickerGestureDetector {
    ...
    private StickerVector2D mCurrSpanVector = new StickerVector2D();
    ...
    public interface OnScaleGestureListener {
        boolean onScale(View view, StickerGestureDetector stickerGestureDetector);

        boolean onScaleBegin(View view, StickerGestureDetector stickerGestureDetector);

        void onScaleEnd(View view, StickerGestureDetector stickerGestureDetector);
    }
    ...
    public static class SimpleOnScaleGestureListener implements OnScaleGestureListener {
        ...
        public void onScaleEnd(View view, StickerGestureDetector detector) {
        }
    }

    public StickerGestureDetector(OnScaleGestureListener listener) {
    ...
    public StickerVector2D getCurrentSpanVector() {
